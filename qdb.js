...
//预处理
function pre() {
    let file = "hiker://files/rules/jokerB/qdb_config.js";
    if (!fetch(file)) {
...
extra: {ua: MOBILE_UA}
    ...
    d.push({
        title: '设置',
        //img: 'https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/hikerdbw/main/img/豆瓣.png',
    ...
    let img = "https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/hikerdbw/main/img/";
    for (let i in s) {
        d.push({
            title: s[i],
            img: img + s[i] + '.jpg',
...
function detailsView(type, id) {
    ...
    let relatedItems = [{
        title: "剧照",
        img: "https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/hikerdbw/main/img/剧照.png",
        ...
        title: "演职",
        img: "https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/hikerdbw/main/img/演职.png",
        url: $('hiker://empty/#/$page{fypage}#noHistory#').rule((t) => {
            eval(fetch(getVar("qdb_file")));
            credits(t[0], t[1]);
        }, [i.subtype, i.id]),
        ...
        title: "短评",
        img: "https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/hikerdbw/main/img/短评.png",
        url: $('hiker://empty/#/$page{fypage}#noHistory#').rule((t) => {
            eval(fetch(getVar("qdb_file")));
        ...
        title: "剧评",
        img: "https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/hikerdbw/main/img/剧评.png",
        url: $('hiker://empty/#/$page{fypage}#noHistory#').rule((t) => {
            eval(fetch(getVar("qdb_file")));
    ...
    if (i.trailer) {
        ...
        videoRelatedItems.push({
            title: '查看更多',
            img: "https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/hikerdbw/main/img/more.png",
            col_type: "movie_2",
            url: $('hiker://empty/#/$page{fypage}#noHistory#').rule((t) => {
                eval(fetch(getVar("qdb_file")));
                trailers(t[0], t[1]);
...
function settingPage() {
    ...
    d.push({
        ...
        url: $('hiker://empty').lazyRule((currentVersion) => {
            let gitfile = request("https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/hikerdbw/main/qdb.js");
            eval(gitfile);
            if (version > currentVersion) {
                return $("发现新版本,是否更新?").confirm((gitfile) => {
                    writeFile("hiker://files/rules/jokerB/qdb.js", gitfile);
                    back(true);
