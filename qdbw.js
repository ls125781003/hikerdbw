...
d.push({
    title: '⚙️设置',
    img: 'https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/tubiao/main/erdi/64.png',
    desc: '0',
    col_type: 'text_icon',
...
let img = "https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/hikerdbw/master/img/";
for (let i in s) {
    d.push({
        title: s[i],
        img: img + s[i] + '.jpg',
...
function settingPage() {
    ...
    d.push({
        ...
        url: $('hiker://empty').lazyRule((currentVersion) => {
            let gitfile = request("https://ghproxy.com/https://raw.githubusercontent.com/ls125781003/hikerdbw/master/qdbw.js");
            eval(gitfile);
